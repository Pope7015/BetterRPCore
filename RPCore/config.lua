...
Config.removeparkedvehicles = false -- Removes all parked vehicles
...
Config.ragdoll_chance = 0.5 -- Edit this decimal value for chance of falling (e.g. 80% = 0.8    75% = 0.75    32% = 0.32)
...
Config.secondsuntilkick = 1000 -- AFK Kick Time Limit (in seconds)
...
Config.prefix = 'ARP^0: ' -- Prefix appears in front of each message.
